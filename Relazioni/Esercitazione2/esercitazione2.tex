...
Dominio = {Colore1, Colore2, Colore3, Colore4}
	...
	\section{Esercizio 4}
		...
		Ma in questo caso conoscendo il tipo di problema possiamo anche adattare l'algoritmo alla nostro problema, infatti modificandolo possiamo fare in modo tale che esso converga, in un tempo, più o meno breve, ad una soluzione.
		...
		Ovviamente tale soluzione potrebbe far in modo che il nostro algoritmo non termini mai,per ovviare a questo problema potremmo introdurre degli elementi di casualità che impedescono al nostro algoritmo di ritrovarsi in loop senza fine.
